...
namespace Dapper.CQS.Internal
{
    ...
    internal class SqlTransientExceptionDetector : IExceptionDetector
    {
        private static readonly int[] _handledErrorNumbers =
        {
        ...
        public bool ShouldRetryOn(Exception ex)
        {
            ...
            foreach (SqlError err in sqlException.Errors)
                return _handledErrorNumbers.Contains(err.Number);
